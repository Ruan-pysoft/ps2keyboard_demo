...
I made this because I spent multiple days in my [C++ kernel](TODO) trying to get PS/2 keyboard support working, without success. I suspect I have issues with my GDT and/or IDT setup, but it is very difficult to check, since I wasn't able to find a small, working kernel that can demonstrate how to set up the IDT, GDT, and PS/2 support; or I _could_, but all of them did a hundred different stuff as well, so it was difficult finding and isolating the parts I was interested in. So, I made my own reference.
